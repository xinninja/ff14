local tbl = 
{
	...
	
	{
		actions = 
		{
			
			{
				aType = 4,
				actionID = -1,
				actionLua = "local start,mid,finish,line = AnyoneCore.convertSettingsToU32()\nfor id, ent in pairs(EntityList(\"\")) do\n\tif ent.contentid == 2210  and  not (ent.pos.x ==0) then\n\t\t\t\tArgus2.addTimedDonutFilled(9000,ent.pos.x,ent.pos.y,ent.pos.z,6,5,50,start,finish,mid,0,ent.id,GUI:ColorConvertFloat4ToU32(1, 1, 0, 0.1),line)\n\tend\nend\nzerohatch=false\nself.used = true",
				allowInterrupt = false,
				atomicPriority = false,
				castAtMouse = false,
				castPosX = 0,
	...
	
	{
		...
		timerStartOffset = 0,
		used = false,
		uuid = "2695896f-58e4-eaeb-8187-11dc745cccf1",
	},
